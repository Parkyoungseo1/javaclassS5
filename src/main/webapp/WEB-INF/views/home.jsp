...
<div class="w3-main" style="margin-left:300px">
  ...
  <div class="w3-container w3-padding-large" style="margin-bottom:32px">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/-voN2X3U_gk?si=lAUCFWisK-fovoqN" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    
	<!-- Images of Me -->
  <div class="w3-row-padding w3-padding-16" id="about">
    <div class="w3-col m6">
      <img src="${ctp}/images/main3.jpg" alt="Me" style="width:100%">
    </div>
    <div class="w3-col m6">
      <img src="${ctp}/images/main2.jpg" alt="Me" style="width:100%">
    </div>
  </div>
