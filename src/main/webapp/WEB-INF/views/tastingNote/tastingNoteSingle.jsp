...
<head>
  <meta charset="UTF-8">
  <title>tastingNoteSingle.jsp</title>
...
<div class="container">
  <table class="table table-borderless">
    ...
    <tr>
      ...
      <td class="text-right">
        <input type="button" value="사진올리기" onclick="location.href='tastingNoteInput';" class="btn btn-success"/>
        <input type="button" value="여러장씩보기" onclick="location.href='tastingNoteList';" class="btn btn-info mr-2"/>
      </td>
    </tr>
  </table>
