...
<div class="container">
  <form name="myform" method="post" class="was-validated" enctype="multipart/form-data">
    ...
    <button type="button" class="btn" onclick="fCheck()">Join the Club</button> &nbsp;
    <button type="reset" class="btn">Reset</button> &nbsp;
    <button type="button" class="btn" onclick="location.href='${ctp}/member/memberLogin';">Back to Bar</button>
